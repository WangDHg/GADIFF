...
class PropertyCalculator(object):
    ...
    def __init__(self, threads, memory, seed):
        ...
        self.pk = Psikit(threads=threads, memory=memory, debug=True)
        self.seed = seed
    ...
    def __call__(self, data, num_confs=50):
        ...
        conf_idx = np.arange(confs.shape[0])                        # num_mol
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='qm9_property.pt')
    parser.add_argument('--generated', type=str, default='logs/qm9_para_2024_04_12__02_24_38_n_500/sample_2024_04_14__19_31_55/samples_all.pkl')
